...
workdir=$(pwd) #go to workdir and goto cohesion-prerequisite give the excutive permission to conhesion-prerequisite and run the file
...
#check the above cmd is correct or not using $?
if [[ $? -eq 0 ]]
then
